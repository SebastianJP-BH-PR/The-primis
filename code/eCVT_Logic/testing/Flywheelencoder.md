...
[see here](../../../code\Media\flywheelencodercounter.py)

- Then we added a timer to print the time interval between every pulse.             
[see here](../../../code\Media\Flywheelencodertimer.py)
...
[see here](../../../code\Media\Flywheelencoder7sample.py)
...
[see here](../../../code\Media\Flywheelencoder0timeout.py)
...
- And finally, calculate the RPM with the calculated average time interval with this formula:
    ...
    [see here](../../../code\Media\FlywheelencoderRPM.py)