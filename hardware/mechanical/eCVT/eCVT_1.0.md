...
Our plan was to make the pneumatic engines input on the sun gear, the electric motor's input on the planetary carrier and the output to be the ring gear.
